    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          return (T) new AllDebridRepository(singletonCImpl.provideAllDebridApiProvider.get(), singletonCImpl.provideSettingsDataStoreProvider.get(), singletonCImpl.provideOkHttpClientProvider.get());
