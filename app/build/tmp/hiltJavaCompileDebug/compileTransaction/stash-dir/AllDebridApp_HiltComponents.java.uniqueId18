...
import com.samcod3.alldebrid.di.AppModule;
...
public final class AllDebridApp_HiltComponents {
  private AllDebridApp_HiltComponents() {
  }
  ...
  @Singleton
  public abstract static class SingletonC implements AllDebridApp_GeneratedInjector,
  ...
  @Subcomponent(
      modules = {
          ...
          ApiKeyManagerViewModel_HiltModules.KeyModule.class,
  ...
  @Subcomponent(
      modules = {
          ApiKeyManagerViewModel_HiltModules.BindsModule.class,
